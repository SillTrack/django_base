...
urlpatterns = [
    ...
    path('categories/read/<int:pk>/', adminapp.ProductReadView.as_view(), name='category_read'),
    path('categories/update/<int:pk>/', adminapp.ProductCategoryUpdateView.as_view(), name='category_update'),
    path('categories/delete/<int:pk>/', adminapp.product_category_delete, name='category_delete'),
